...
C {devices/vsource.sym} 30 65 0 0 {name=V1 value=" DC 1.8" savecurrent=false}
C {devices/gnd.sym} 30 95 0 0 {name=l2 lab=GND}
C {devices/lab_pin.sym} 30 35 1 0 {name=p2 sig_type=std_logic lab=VDD}
C {devices/isource.sym} -60 60 0 0 {name=I0 value=5u}
C {devices/lab_pin.sym} -60 30 1 0 {name=p9 sig_type=std_logic lab=VDD}
C {devices/lab_pin.sym} -60 90 3 0 {name=p10 sig_type=std_logic lab=Ibias}
